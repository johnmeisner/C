/*----------------------------------------------------------------------------*/
/*                                                                            */
/* Filename: rxSignedWSMsNoVerify.c                                           */
/*  Purpose: Simple sample program to receive signed WSMs.                    */
/*                                                                            */
...
/*----------------------------------------------------------------------------*/
/*
 * Receives signed WSM's with no verification. No calls to smiInitialize() or
 * smiTerm() are needed.
 */
...
int init(void)
{
    ...
    risRet = wsuRisInitRadioComm("rxSignedWSMsNoVerify", &appCredential);

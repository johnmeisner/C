...
/*----------------------------------------------------------------------------*/
/*
 * Receives signed WSM's with verification once a second via VTP. Calls to
...
int init(void)
{
    ...
    risRet = wsuRisInitRadioComm("rxSignedWSMsWithVerifyVTP", &appCredential);

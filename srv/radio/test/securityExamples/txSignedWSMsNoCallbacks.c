/*----------------------------------------------------------------------------*/
/*                                                                            */
/* Filename: txSignedWSMsNoCallbacks.c                                        */
/*  Purpose: Simple sample program to transmit signed WSMs with no callbacks. */
/*                                                                            */
...
/*----------------------------------------------------------------------------*/
/*
 * Transmits 10 signed WSM's per seconds with no callbacks. Therefore,
...
int init(void)
{
    ...
    risRet = wsuRisInitRadioComm("txSignedWSMsNoCallbacks", &appCredential);
...
int main(int argc, char **argv)
{
    int              retVal = 0;
    rsResultCodeType risRet;
    uint8_t          payload[] = "Tx signed WSMs no callbacks";
    int              txCount = 0;
    cfgType          getCfg;

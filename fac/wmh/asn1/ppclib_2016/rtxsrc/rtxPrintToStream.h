...
/**
 * This function prints the value of a binary string in hex format
 * to standard output.  In contrast to rtxPrintToStreamHexStr, it is
 * always printed on a single line with a '0x' prefix.
 *
 * @param pctxt        A pointer to a context structure.
 * @param name         The name of the variable to print.
 * @param numocts      The number of octets to be printed.
...
/**
 * This function prints the value of a binary string in hex format
 * to standard output.  In contrast to rtxPrintToStreamHexStr, it
 * contains no ASCII output, but instead is a formatted block of hex text
 * printed on multiple lines if needed.
 *
 * @param pctxt        A pointer to a context structure.
 * @param name         The name of the variable to print.
 * @param numocts      The number of octets to be printed.
...
/**
 * This function outputs a formatted hexadecimal dump of the current buffer to
 * a print stream. It outputs the dump as an array of bytes, words, or double
 * words. It does not output any ASCII equivalent.
 *
 * @param pctxt        A pointer to a context structure.
 * @param data         The pointer to a buffer to be displayed.
 * @param numocts      The number of octets to be displayed.

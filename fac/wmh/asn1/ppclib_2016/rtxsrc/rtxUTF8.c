...
#define UTF8TOUNICODE_FN rtxUTF8ToUnicode
#define UTF8TOUNICODE_UNI_TYPE OSUNICHAR
#include "rtxUTF8ToUnicode.c"

#undef UTF8TOUNICODE_FN
#undef UTF8TOUNICODE_UNI_TYPE

#define UTF8TOUNICODE_FN rtxUTF8ToUnicode32
#define UTF8TOUNICODE_UNI_TYPE OS32BITCHAR
#include "rtxUTF8ToUnicode.c"
...
(OSCTXT* pctxt, const OSUTF8CHAR* utf8str)
{
   return (rtxMemCheckPtr (pctxt, utf8str)) ?
      (OSUTF8CHAR*)rtxMemAutoPtrRef (pctxt, utf8str) :
      rtxUTF8Strdup (pctxt, utf8str);
}

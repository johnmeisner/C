OSXML_SAX_C_OBJECTS = \
$(OBJDIR)$(PS)rtSaxDiag$(OBJ) \
$(OBJDIR)$(PS)rtSaxErrors$(OBJ) \
$(OBJDIR)$(PS)rtSaxFindElemID$(OBJ) \
$(OBJDIR)$(PS)rtSaxFindElemID8$(OBJ) \
$(OBJDIR)$(PS)rtSaxGetAttributeID$(OBJ) \
$(OBJDIR)$(PS)rtSaxGetAttrValue$(OBJ) \
$(OBJDIR)$(PS)rtSaxGetElemID$(OBJ) \
$(OBJDIR)$(PS)rtSaxGetElemID8$(OBJ) \
$(OBJDIR)$(PS)rtSaxHasXMLNSAttrs$(OBJ) \
$(OBJDIR)$(PS)rtSaxIsEmptyBuffer$(OBJ) \
$(OBJDIR)$(PS)rtSaxLookupElemID$(OBJ) \
$(OBJDIR)$(PS)rtSaxLookupElemID8$(OBJ) \
$(OBJDIR)$(PS)rtSaxReportUnexpAttrs$(OBJ) \
$(OBJDIR)$(PS)rtSaxSetSkipLevelToCurrent$(OBJ) \
$(OBJDIR)$(PS)rtSaxTestAttributesPresent$(OBJ)

OSXML_PULL_C_OBJECTS = \
...
OSXML_C_BASEOBJECTS = \
$(OSXML_COMMON_RTOBJECTS) \
$(OBJDIR)$(PS)rtSaxCAny$(OBJ) \
$(OBJDIR)$(PS)rtSaxCAnyType$(OBJ) \
$(OBJDIR)$(PS)rtSaxCSimpleType$(OBJ) \
$(OBJDIR)$(PS)rtSaxCSoap$(OBJ) \
$(OBJDIR)$(PS)rtSaxCStrList$(OBJ) \
$(OBJDIR)$(PS)rtSaxCXmlHandler$(OBJ) \
$(OBJDIR)$(PS)rtSaxCXmlStreamHandler$(OBJ) \
$(OBJDIR)$(PS)rtSaxSortAttrs$(OBJ) \
...
OSXML_SAX_CPP_OBJECTS = \
$(OBJDIR)$(PS)rtSaxCppParser$(OBJ) \
$(OBJDIR)$(PS)rtSaxCppSimpleType$(OBJ)

OSXML_PULL_CPP_OBJECTS = \

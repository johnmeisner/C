 ...
 */
#ifndef SENSORDATASHARINGMESSAGE_H
#define SENSORDATASHARINGMESSAGE_H
...
/**
 * Header file for ASN.1 module SensorDataSharingMessage
 */
/**************************************************************/
/*                                                            */
...
/**************************************************************/
/*
SensorDataSharingMessage ::= NULL
*/
typedef void SensorDataSharingMessage;

EXTERN int asn1PE_SensorDataSharingMessage_ (OSCTXT* pctxt, void* pvalue);
#define asn1PE_SensorDataSharingMessage(pctxt) \
asn1PE_SensorDataSharingMessage_(pctxt, NULL)

EXTERN int asn1PD_SensorDataSharingMessage_ (OSCTXT* pctxt, void* pvalue);
#define asn1PD_SensorDataSharingMessage(pctxt) \
asn1PD_SensorDataSharingMessage_(pctxt, NULL)

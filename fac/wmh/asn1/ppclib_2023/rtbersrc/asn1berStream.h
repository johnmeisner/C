...
/**
 * This function encodes a variable one of the ASN.1 ISO 8601 Date character
 * string types.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 ...
 *                       negative return value is error.
 */
EXTERNBER int berEncStrmDateStr (OSCTXT* pctxt, const char* object_p,
                                 ASN1TagType tagging, ASN1TAG tag);

/**
 * This function encodes a variable one of the ASN.1 ISO 8601 Date/Time
 ...
 *                       negative return value is error.
 */
EXTERNBER int berEncStrmDateTimeStr (OSCTXT* pctxt, const char* object_p,
                                     ASN1TagType tagging, ASN1TAG tag);

/**
 * This function encodes a variable one of the ASN.1 ISO 8601 Duration character
 * string types.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 ...
 *                       negative return value is error.
 */
EXTERNBER int berEncStrmDurationStr (OSCTXT* pctxt, const char* object_p,
                                     ASN1TagType tagging, ASN1TAG tag);

/**
 * This function encodes a variable one of the ASN.1 ISO 8601 Time character
 * string types.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 ...
 *                       negative return value is error.
 */
EXTERNBER int berEncStrmTimeStr (OSCTXT* pctxt, const char* object_p,
                                 ASN1TagType tagging, ASN1TAG tag);

/**
 * This function encodes a variable one of the ASN.1 ISO 8601 Time-Of-Day
 * character string types.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 ...
 *                       negative return value is error.
 */
EXTERNBER int berEncStrmTimeOfDayStr (OSCTXT* pctxt, const char* object_p,
                                      ASN1TagType tagging, ASN1TAG tag);
...
/**
 * This function encodes a variable of the ASN.1 OBJECT IDENTIFIER type.
 * The structure in this case hold a pointer to an array of subidentifiers
 ...
 *                       negative return value is error.
 */
EXTERNBER int berEncStrmDynObjId
 ...
 * specification. This function is also called from within the run-time library
 * functions to handle the addition of the universal tags defined for each of
 * the ASN.1 primitive data types.  This version will always encode the length
 ...
 *                       representation. It is passed as an unsigned 32-bit
 *                       integer.
 * @param length       The length of the contents field.
 * @return             Completion status of operation: 0 (0) = success,
 *                       negative return value is error.
 */
EXTERNBER int berEncStrmTagAndDefLen
(OSCTXT *pctxt, ASN1TAG tag, OSSIZE length);
...
*                       - negative return value is error.
*/
EXTERNBER int berDecStrmCharArray(OSCTXT* pctxt, char* charArray,
   OSSIZE arraySize, ASN1TagType tagging,
   ASN1TAG tag, int length);


/**
 * This function decodes a variable of one of the ASN.1 ISO 8601 Date character
 * string types.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 ...
 *                       negative return value is error.
 */
EXTERNBER int berDecStrmDateStr (OSCTXT *pctxt, const char** ppvalue,
                                 ASN1TagType tagging, ASN1TAG tag, int length);

/**
 * This function decodes a variable of one of the ASN.1 ISO 8601 Date/Time
 * character string types.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 ...
 *                       negative return value is error.
 */
EXTERNBER int berDecStrmDateTimeStr (OSCTXT *pctxt, const char** ppvalue,
                                     ASN1TagType tagging, ASN1TAG tag, int length);

/**
 * This function decodes a variable of one of the ASN.1 ISO 8601 Duration
 *  character string types.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 ...
 *                       negative return value is error.
 */
EXTERNBER int berDecStrmDurationStr (OSCTXT *pctxt, const char** ppvalue,
                                     ASN1TagType tagging, ASN1TAG tag, int length);

/**
 * This function decodes a variable of one of the ASN.1 ISO 8601 Time character
 * string types.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 ...
 *                       negative return value is error.
 */
EXTERNBER int berDecStrmTimeStr (OSCTXT *pctxt, const char** ppvalue,
                                 ASN1TagType tagging, ASN1TAG tag, int length);

/**
 * This function decodes a variable of one of the ASN.1 ISO 8601 Time-Of-Day
 * character string types.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 ...
 *                       negative return value is error.
 */
EXTERNBER int berDecStrmTimeOfDayStr (OSCTXT *pctxt, const char** ppvalue,
                                      ASN1TagType tagging, ASN1TAG tag, int length);
 ...
 *                       explicit, the length is obtained from the decoded
 *                       length field.
 * @param indefLen     Boolean indicating component is indefinite length.
 * @return             Completion status of operation: 0 (0) = success,
 *                       negative return value is error.
 */
EXTERNBER int berDecStrmDynBitStr64 (OSCTXT *pctxt, const OSOCTET** ppvalue,
...
/**
 * This version of berDecStrmDynOctStr provides true 64-bit support by using
 * an OSSIZE type (by default, an abstraction for size_t) to hold the
 * decoded number of octets.  On 64-bit systems, this will be a 64-bit
 * number.  This also fixes the issue of using a const pointer for the
 * returned data since the variable is mutable.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 *                       that must be maintained between function calls.
 * @param ppvalue      A pointer to a pointer (**) to hold the address of a
 *                       byte buffer to receive decoded OCTET STRING content.
 * @param pnocts       Pointer to an integer value to receive the decoded
 *                       number of octets.
 * @param tagging      An enumerated type whose value is set to either
 *                       'ASN1EXPL' (for explicit tagging) or 'ASN1IMPL' (for
 ...
 *                       negative return value is error.
 */
EXTERNBER int berDecStrmDynOctStr64 (OSCTXT* pctxt, OSOCTET** ppvalue,
                                     OSSIZE* pnocts, ASN1TagType tagging,
                                     OSSIZE length, OSBOOL indefLen);

/**
 * This function decodes a variable of the ASN.1 OBJECT IDENTIFIER type. It
 * will allocate dynamic memory to store the decoded result.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 *                       that must be maintained between function calls.
 * @param object_p     Pointer to dynamic object identifier structure to
 ...
 *                       negative return value is error.
 */
EXTERNBER int berDecStrmDynObjId
...
EXTERNBER int berDecStrmEnumInt8 (OSCTXT *pctxt, OSINT8 *object_p,
                                  ASN1TagType tagging, int length);

EXTERNBER int berDecStrmEnumInt16 (OSCTXT *pctxt, OSINT16 *object_p,
                                   ASN1TagType tagging, int length);

EXTERNBER int berDecStrmEnumUInt (OSCTXT *pctxt, OSUINT32 *object_p,
                                  ASN1TagType tagging, int length);

EXTERNBER int berDecStrmEnumUInt8 (OSCTXT *pctxt, OSUINT8 *object_p,
                                   ASN1TagType tagging, int length);

EXTERNBER int berDecStrmEnumUInt16 (OSCTXT *pctxt, OSUINT16 *object_p,
                                    ASN1TagType tagging, int length);

#define berDecStrmEnumInt berDecStrmEnum

/**
 * This function searches the stream being decoded for the first match
 * of the given tag from the current stream position.  If the tag is
 * fount, the decode stream position will be set to either the start
 * of the tag or to the start of the contents depending on the value
 * of the advance flag.  If not found, the stream positiion will be
 * returned to the position from which the search started.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 *                       that must be maintained between function calls.
 ...
 */
EXTERNBER int berDecStrmFindTag
(OSCTXT* pctxt, ASN1TAG tag, int* len_p, OSBOOL advance);

/**
 * This version of berDecStrmFindTag supports messages with length fields
 * longer than will fit in a signed 32-bit integer value (up to unsigned
 * 64-bit lengths on 64-bit machines).
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 *                       that must be maintained between function calls.
 ...
 * @param pIndefLen    Pointer to boolean variable which will be set to
 *                       true if length is indefinite.  Length returned
 *                       in pLength should be disregarded in this case.
 * @param advance      The boolean value indicates the behaviour of the decode
 *                       pointer. If it is set to TRUE and match is successful,
 *                       then the pointer will be moved behind the tag.
 *                       Otherwise, it will be left unchanged.
 ...
 *                       - negative value - error occurred.
 */
EXTERNBER int berDecStrmFindTag2
...
/**
 * This function decodes a BER length determinant value.  This version
 * of the function can support lengths larger than can be held in a
 * signed 32-bit integer value (up to 64-bits unsigned on a 64-bit machine).
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 *                       that must be maintained between function calls.
 * @param pLength      Pointer to a variable to receive the decoded length of
 *                       the tagged component.
 * @param pIndefLen    Pointer to boolean variable which will be set to
 *                       true if length is indefinite.  Length returned
 *                       in pLength should be disregarded in this case.
 ...
 *                       negative return value is error.
 */
EXTERNBER int berDecStrmLength2
(OSCTXT* pctxt, OSSIZE* pLength, OSBOOL* pIndefLen);
 ...
 * the result of the match operation.
 *
 * This version of the function can support lengths larger than can be
 * held in a signed 32-bit integer value (up to 64-bits unsigned on a
 * 64-bit machine).
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 ...
 * @param pIndefLen    Pointer to boolean variable which will be set to
 *                       true if length is indefinite.  Length returned
 *                       in len_p should be disregarded in this case.
 * @param advance      The boolean value indicates the behaviour of the decode
 *                       pointer. If it is set to TRUE and match is successful,
 *                       then the pointer will be moved behind the tag.
 *                       Otherwise, it will be left unchanged.
 ...
 *                       - negative value - error occurred.
 */
EXTERNBER int berDecStrmMatchTag2
(OSCTXT* pctxt, ASN1TAG tag, OSSIZE *len_p, OSBOOL* pIndefLen, OSBOOL advance);
...
/**
 * This function decodes ASN.1 OBJECT IDENTIFIER subidentifiers into the
 * given array variable.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 *                       that must be maintained between function calls.
 * @param subidArray   Pre-allocated array into which decoded subidentifer
 *                       values will be stored. The array holds 32-bit
 *                       subidentifier values.
 * @param subidArraySize Number of subidentifiers the array can hold.
 * @param enclen       The length, in octets, of the contents field to be
 *                       decoded.
 * @return             Completion status of operation: if success, the number
 *                       of decoded subidentifers is returned; if error,
 *                       a negative error status code is returned.
 */
EXTERNBER int berDecStrmOIDSubIds
...
EXTERNBER int berDecStrmOctStr64(OSCTXT *pctxt, OSOCTET* pvalue,
                                 OSSIZE* pnocts, ASN1TagType tagging,
                                 OSSIZE length, OSBOOL indefLen);
 ...
 * @param pnumocts    Pointer to a size-typed variable to receive the decoded
 *                       number of octets.
 * @return             Completion status of operation: 0 (0) = success,
 *                       negative return value is error.
 */
 ...
 *                       negative error code.
 */
EXTERNBER int berDecStrmReadTLV (OSCTXT* pctxt, OSOCTET* buf, OSSIZE bufsiz);

/**
 * This function decodes a variable of the binary encoded ASN.1 REAL type.
 * This function allows the encoding to be in any base.
 * This is used for REAL values that could be base 2 or base 10, for BER.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 *                       that must be maintained between function calls.
...
/**
 * This function decodes a variable of the binary encoded ASN.1 REAL type.
 * This function requires the encoding to be in base 2, 8, or 16.
 * This is used for REAL values that must be base 2, for BER.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 *                       that must be maintained between function calls.
 ...
 *                       negative return value is error.
 */
EXTERNBER int berDecStrmRealBin (OSCTXT *pctxt, OSREAL *object_p,
                              ASN1TagType tagging, int length);

/**
 * This function decodes a variable of the binary encoded ASN.1 REAL type.
 * This function requires the encoding to be in base 2.
 * This is used for REAL values that must be base 2, for CER and DER.
 *
 * @param pctxt        Pointer to a context structure. This provides a storage
 *                       area for the function to store all working variables
 *                       that must be maintained between function calls.
 ...
 *                       negative return value is error.
 */
EXTERNBER int berDecStrmRealDer (OSCTXT *pctxt, OSREAL *object_p,
                              ASN1TagType tagging, int length);
/**
 ...
 *                       negative return value is error.
 */
EXTERNBER int berDecStrmTagAndLen2
...
EXTERNBER OSBOOL berDecStrmTestEOC2 (OSCTXT* pctxt);
...
EXTERNBER int berDecStrmUInt64 (OSCTXT *pctxt, OSUINT64 *object_p,
 ...
 #define berDecStrmSize(pctxt, object_p, tagging, length) \
            berDecStrmUInt(pctxt, object_p, tagging, length)
#elif defined OSSIZE_IS_64BITS
 #define berDecStrmSize(pctxt, object_p, tagging, length) \
            berDecStrmUInt64(pctxt, object_p, tagging, length)
#endif
...
EXTERNBER int berDecStrmUnivStr (OSCTXT* pctxt,
                                 ...
                                 ASN1TagType tagging, int length);
/** @} */
#define cerEncCanonicalSort (pctxt, pMemCtxt, pList) \
   rtxEncCanonicalSort(pctxt, pMemCtxt, pList)

#define cerGetBufLocDescr (pctxt, pDescr) \
   rtxGetBufLocDescr(pctxt, pDescr)

#define cerAddBufLocDescr (pctxt, pElemList, pDescr) \

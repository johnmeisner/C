...
class EXTERNBER ASN1BERLength {
 ...
 public:
   ...
   inline OSSIZE getLength() const { return mLength; }
   inline OSBOOL isEOC (ASN1TAG tag) const {
      return (tag == ASN_ID_EOC && mLength == 0);
   }
   ...
   inline operator int() const { return getIntLength(); }
...
class EXTERNBER ASN1BERDecodeBuffer : public ASN1BERMessageBuffer {
 ...
 public:
   ...
   */
   ...
   /**
    * This method sets a buffer containing a message to be decoded.  This
    * method differs from setBuffer() in that only the buffer pointer is
    * set; no BER-specific processing is done.
    *
    * @param pMsgBuf      A pointer to a memory buffer containing a message to
    *                       be decoded. The buffer should be declared as an
    *                       array of unsigned characters (OSOCTETs).
    ...
    *                       - negative return value is error.
    */
   int setBufPtr (const OSOCTET* pMsgBuf, OSSIZE msgBufLen);
   ...
   friend class ASN1BERTS32297CDRFileHeader;
} ;

/**
  * The ASN1BERTS32297CDRFileHeader class wraps the TS32297CDRFileHeader structure
  * and also provides a decode() method.
  */
class EXTERNBER ASN1BERTS32297CDRFileHeader
{
private:
   TS32297CDRFileHeader mFileHeaderData;
   ASN1MessageBuffer* mpBufferOrStream;
   OSSIZE mOffset;
   OSSIZE mMsgBufLen;
...
public:
   ...
   /**
    * This constructor initializes an instance using the passed ASN1MessageBuffer.
    *
    * @param pMessageBuffer A pointer to an instance of an ASN1MessageBuffer.
    */
   ASN1BERTS32297CDRFileHeader (ASN1MessageBuffer* pMessageBuffer);

   /**
    * This method decodes the TS 32.297 file header indicated by the decode
    * buffer.
    *
    * @return The length of the file header, or a negative value if an error
    *         occurs.
    */
   int decode();

   /**
    * This method prints the contents of the TS 32.297 file header to standard
    * output.
    */
   void print();

   /**
    * This method prints information about decode errors.
    *
    */
   void printErrorInfo();

   /**
    * This method returns a pointer to the encapsulated TS32297CDRFileHeader
    * structure.
    */
   TS32297CDRFileHeader* getFileHeaderData() { return &mFileHeaderData; }

   friend class ASN1BERTS32297CDRHeader;

};

/**
  * The ASN1BERTS32297CDRHeader class wraps the TS32297CDRHeader structure
  * and also provides a decode() method.
  */
class EXTERNBER ASN1BERTS32297CDRHeader
{
   TS32297CDRHeader mHeaderData;
   ASN1BERTS32297CDRFileHeader& mFileHeader;

public:

   /**
    * This constructor initializes an instance using the passed ASN1BERTS32297CDRFileHeader.
    *
    * @param fileHeader A reference to an instance of a TS 32.297 file header object.
    */
   ASN1BERTS32297CDRHeader (ASN1BERTS32297CDRFileHeader& fileHeader) :
      mFileHeader(fileHeader) {};

   /**
    * This method initializes the encapsulated TS32297CDRHeader structure.
    */
   void init();

   /**
    * This method decodes the TS 32.297 CDR header indicated by the decode
    * buffer in the file header object.
    *
    * @return The length of the CDR header, or a negative value if an error
    *         occurs.
    */
   int decode();

   /**
    * This method prints the contents of the TS 32.297 CDR header to standard
    * output.
    */
   void print();
   ...
   /**
    * This method returns a pointer to the encapsulated TS32297CDRHeader
    * structure.
    */
   TS32297CDRHeader* getHeaderData() { return &mHeaderData; }

   /**
    * This method advances to the beginning of the next CDR header in the
    * decode buffer.
    *

...
int xd_null (OSCTXT *pctxt, ASN1TagType tagging)
{
   if (tagging == ASN1EXPL) {
      ...
      /* Check length to make sure it is zero.
         The most common case will be a definite length of zero in short form.
         If we find we don't have that, we back up and use xd_len64.
         As NULL uses primitive encoding, the length must be a definite length.
      */

...
class EXTERNBER ASN1BEREncodeStream : public ASN1MessageBuffer
{
 ...
 public:
    ...
    * @see       ::rtxStreamClose
    */
   virtual int close () { return rtxStreamClose(getCtxtPtr()); }
    ...
    * @see       ::rtxStreamFlush
    */
   virtual int flush () { return rtxStreamFlush(getCtxtPtr()); }
   ...
   virtual long write (const OSOCTET* pdata, size_t size) {
      return berEncStrmWriteOctets (getCtxtPtr(), pdata, size);
   }
    ...
    */
   int encodeBitStr (const OSOCTET* pbits, size_t numbits,
    ...
    */
   int encodeOctStr (const OSOCTET* pocts, OSSIZE numocts,
                     ASN1TagType tagging = ASN1EXPL);
   ...
   /**
    * This method encodes a variable of the REAL data type. It encodes as
    * in base 10.
    *
    * @param val                       The number to encode.  It may be
    *                                  represented in integer, decimal, and
    *                                  exponent formats.
    * @param tagging                   An enumerated type whose value is set to
    *                                    either 'ASN1EXPL' (for explicit
    *                                    tagging) or 'ASN1IMPL' (for implicit).
    ...
    * @see                            ::berEncStrmReal
    */
   int encodeReal10(const char* val, ASN1TagType tagging = ASN1EXPL);

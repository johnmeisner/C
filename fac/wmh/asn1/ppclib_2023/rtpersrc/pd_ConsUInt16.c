...
EXTPERMETHOD int pd_ConsUInt16 (OSCTXT* pctxt,
                   OSUINT16* pvalue, OSUINT64 lower, OSUINT64 upper)
{
   OSUINT64 value;
   int stat;
   ...
   if ( stat != 0 ) return LOG_RTERR(pctxt, stat);
      ...
      if (pvalue) *pvalue = (OSUINT16) value;
      return 0;
   }
}

EXTPERMETHOD int pd_ConsUInt16SignedBound (OSCTXT* pctxt,
                   OSUINT16* pvalue, OSINT64 lower, OSINT64 upper)
{
   OSUINT64 value;
   int stat;

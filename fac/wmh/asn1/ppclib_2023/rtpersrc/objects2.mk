PER_C_OBJECTS_NLC = \
   ...
   $(OBJDIR)$(PS)pd_ExtOptElemBits$(OBJ) \
...
PER_C_OBJECTS_LC = \
   $(LCOBJDIR)$(PS)pd_ConsInteger$(OBJ) \
   $(LCOBJDIR)$(PS)pd_ConsUnsigned$(OBJ) \
   $(LCOBJDIR)$(PS)pd_ConstrainedString$(OBJ) \
   $(LCOBJDIR)$(PS)pd_DynOctetString$(OBJ) \
   $(LCOBJDIR)$(PS)pd_DynObjId$(OBJ) \
   $(LCOBJDIR)$(PS)pd_ObjectIdentifier$(OBJ) \
   $(LCOBJDIR)$(PS)pd_OctetString$(OBJ) \
   $(LCOBJDIR)$(PS)pe_common$(OBJ) \
   $(LCOBJDIR)$(PS)pe_ObjectIdentifier$(OBJ) \
   $(LCOBJDIR)$(PS)pe_OctetString$(OBJ) \
   $(LCOBJDIR)$(PS)pe_SmallNonNegWholeNumber$(OBJ)

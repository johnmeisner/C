...
/**
 * This function decodes the contents of an ASN.1 OBJECT IDENTIFIER type into
 * an ASN1OBJID object.
 * Input is expected to be a string of OSUTF8CHAR characters returned
 ...
 *                       - negative return value is error.
 */
EXTERNXML int rtAsn1XmlpDecDynObjId(OSCTXT* pctxt, ASN1DynOBJID* pvalue);


EXTERNXML int rtAsn1XmlEncObjId2
(OSCTXT *pctxt, OSUINT32 numids, const OSUINT32* pSubIds,
 const OSUTF8CHAR* elemName, const OSUTF8CHAR* nsPrefix);


/**
 * This function decodes a variable of the ASN.1 open type.  If the XML
 * open type is in the form of an xmlhstring (see X.681, clause 14.6),
 * it is converted to binary forma and stored in the open type structure.
 * Otherwise, the textual representation is saved as-is.
 *
 ...
 *                       calls.
 * @param pOpenType    A pointer to an open type structure to receive
 *                       the decoded data.
 * @return             Completion status of operation:
 *                       - 0 (0) = success,
 *                       - negative return value is error.
...
(OSCTXT* pctxt, const OS32BITCHAR** ppdata, OSSIZE* pnchars);
...
EXTERNXML int rtAsn1XmlEncRelOID2
(OSCTXT *pctxt, OSUINT32 numids, const OSUINT32* pSubIds,
  const OSUTF8CHAR* elemName, const OSUTF8CHAR* nsPrefix);
...
(OSCTXT* pctxt, const OS32BITCHAR* value, OSSIZE nchars,
 ...
 *
 * @param pctxt        Pointer to context block structure.
 * @param pvalue       Pointer to a variable to receive the decoded value.
 * @return             Completion status of operation:
 *                       - 0 = success,
 *                       - negative return value is error.
 */
 ...
 * stored from MSB to LSB order.
 *
 * This version of the function can hold strings with lengths up to 64 bits
 * in size.
 *
 * @param pctxt        Pointer to context block structure.
 * @param pvalue       Pointer to a variable to receive the decoded value.

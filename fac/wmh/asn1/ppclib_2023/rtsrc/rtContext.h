...
/** This flag turns on canonical OER mode.
    This flag turns on CER mode (canonical BER)
   It could be used, in the future, for other
   encoding rules as well. */
#define ASN1CANON       0x0200

/** This flag turns on DER mode (distinguised BER). */
#define ASN1DER         0x0100
...
typedef struct {
   ...
   /**
    * The raw event handler.  This is maintained as a void pointer
    * because it is stored in different forms in C and C++.
    * In C, it holds a pointer to Asn1CRawEventHandler.
    * In C++, it holds a pointer to Asn1RawEventHandler.
    */
   void* pRawEvtHndlr;
} OSASN1CtxtInfo;
 ...
 *
 * This includes initialization of the ASN.1 data structure.
 *

...
/**
 * @ingroup cppruntime asn1data asn1ctime
 * @{
 */
...
class EXTRTCLASS ASN1TTime {
 public:
   ...
   /**
    * This member variable tells whether we will encode this time according to
    * the Distinguished Encoding Rules (DER) or not.
    */
   OSBOOL mbDerRules;
   ...
   */
   ...
   /**
    * Get a printable ASCII string of the time value.  Memory for the
    * returned string is allocated using the rtxMemAlloc function and
    * is freed either when context memory is freed or explicitly via
    * a call to rtxMemFreePtr.
    *
...
/**
 * @}
 */ // end ingroup cppruntime asn1data asn1ctime

...
/**
 * This function prints the value of a bit string to stdout in binary form.
 *
 * @param name         The name of the variable to print.
 * @param numbits      The number of bits to be printed.
 * @param data         A pointer to the data to be printed.
 ...
 *                       value. This points to either -> or .
 */
EXTERNRT void rtPrintBitStrBin(const char *name, OSSIZE numbits,
                               const OSOCTET *data, const char *conn);

/**
 * This function prints the value of a bit string to stdout as a list
 ...
 */
EXTERNRT void rtPrintBitStrNamed(const char *name, OSSIZE numbits,
 ...
 * @param bitnames     Array of bit string names.
 */
EXTERNRT void rtPrintBitStrNamedExt(const char *name, OSSIZE numbits,

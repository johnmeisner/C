 ...
 * @param bufferSize   The size of the buffer to receive the printed value.
 */
EXTERNRT int rtPrintToStringIpv4Addr(const char* name,
 ...
 * @param bufferSize   The size of the buffer to receive the printed value.
 */
EXTERNRT int rtPrintToStringIpv6Addr(const char* name,
                            OSSIZE numocts, const OSOCTET* data,
                            char* buffer, OSSIZE bufferSize);
 ...
 * @param bufferSize   The size of the buffer to receive the printed value.
 */
EXTERNRT int rtPrintToStringTBCDStr(const char* name,
                            OSSIZE numocts, const OSOCTET* data,
                            char* buffer, OSSIZE bufferSize);
 ...
 * @param bufferSize   The size of the buffer to receive the printed value.
 */
EXTERNRT int rtPrintToStringDateTime(const char* name,
 ...
 * @param bufferSize   The size of the buffer to receive the printed value.
 */
EXTERNRT int rtPrintToStringText(const char* name,
                            OSSIZE numocts, const OSOCTET* data,
                            char* buffer, OSSIZE bufferSize);
 ...
 * @param buffer       Pointer to a buffer to receive the printed value.
 */
EXTERNRT int rtPrintToStringBitStrBin(const char *name, OSSIZE numbits,
                            const OSOCTET *data, const char *conn,
                            char *buffer, OSSIZE bufferSize);

/**
 * This function prints the value of a bit string to a text buffer as a list
 ...
 * @param buffer       Pointer to a buffer to receive the printed value.
 */
EXTERNRT int rtPrintToStringBitStrNamed(const char* name, OSSIZE numbits,
 ...
 * @param bitnames     Array of bit string names.
 */
EXTERNRT int rtPrintToStringBitStrNamedExt(const char* name, OSSIZE numbits,
 ...
 * @param bufferSize   The size of the buffer to receive the printed value.
 */
EXTERNRT int rtPrintToStringOID2
 ...
 * @param bufferSize   The size of the buffer to receive the printed value.
 */
EXTERNRT int rtPrintToStringOIDValue2
 ...
 */
EXTERNRT void rtPrintToStringResetIndent(OSVOIDARG);

 ...
 */
/**
 * @defgroup Asn1EventHandler Event Handlers
 * Event Handler Classes include base classes from which user-defined
 * error handler and event handler classes are derived.  There are two kinds
 * of event handlers:
 * <UL>
 * <LI>Named Event Handlers use element names and provide decoded values.
 * Represented by class Asn1NamedEventHandler.
 * </LI>
 * <LI>Raw Event Handlers use identifiers and provide access to the underlying,
 * raw data. Represented by Asn1RawEventHandler.
 * </LI>
 * @ingroup cppruntime
 * @{
 */

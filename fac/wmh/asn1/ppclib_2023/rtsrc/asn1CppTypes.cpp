...
EXTRTMETHOD int ASN1CType::Decode (OSBOOL free)
{
   ...
   // Constraint violations are considered non-fatal; i.e., they don't
   // stop decoding, but tell the caller about them.
   if (stat == RTERR_CONSVIO) return stat;

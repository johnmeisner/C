...
EXTERNRT int rtCmpTCUINT64 (const OSUINT64* value, const OSUINT64* compValue);
   ...
   #define rtCmpTCSize(value, compValue) rtCmpTCUINT(value, compValue)
#elif defined OSSIZE_IS_64BITS
   #define rtCmpTCSize(value, compValue) rtCmpTCUINT64(value, compValue)
#endif

EXTERNRT int rtCmpTCOID (const ASN1OBJID* pOID, const ASN1OBJID* pcompOID);
EXTERNRT int rtCmpTCOID2(OSUINT32 keySize, const OSUINT32* keyIds,
   OSUINT32 compSize, const OSUINT32* compIds);

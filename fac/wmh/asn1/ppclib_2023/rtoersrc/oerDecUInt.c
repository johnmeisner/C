...
/* Decode an OER 16-bit unsigned integer */

EXTOERMETHOD int oerDecUInt16 (OSCTXT* pctxt, OSUINT16* pvalue)
{
   OSOCTET tmpbuf[2];
...
/* Decode an OER 32-bit unsigned integer */

EXTOERMETHOD int oerDecUInt32 (OSCTXT* pctxt, OSUINT32* pvalue)
{
   OSOCTET tmpbuf[4];

 ...
 * @param pctxt       Pointer to context block structure.
 *
 * @param pvalue      Pointer to Asn1BMPString structure to be
 *                    populated with the decoded information.
 *
 * @return            Completion status of operation:
 *                      - 0 (0) = success,
 *                      - negative return value is error.
 */
EXTERNOER int oerDecBMPStr(OSCTXT* pctxt, ASN1BMPString* pvalue);

/**
 * This function decodes an unknown CHOICE extension element.
 * It captures the encoded tag, length determinant, and encoding of the
 * alternative itself.
 *
 * @param pctxt      Pointer to context block structure.
 * @param tag        The previously decoded tag, provided so that it can be
 *                   captured as part of data in ppvalue, for possible later
 *                   reencoding.
 * @param ppvalue    Receives a pointer to dynamically allocated buffer holding
 *                   the tag, length determinant, and alternative encoding.
 *                   Memory for the buffer is allocated using the rtxMemAlloc
 *                   function and should be subsequently freed using the
 *                   rtxMemFree or rtxMemFreePtr functions.
 * @param pnocts     Pointer to variable to receive the size of the data
 *                   held in the buffer pointed to by *ppvalue.
 * @return           Completion status of operation:
 *                      - 0 (0) = success,
 *                      - negative return value is error.
 */
EXTERNOER int oerDecChoiceExt(OSCTXT* pctxt, ASN1TAG tag, OSOCTET** ppvalue,
                              OSSIZE* pnocts);
 ...
 * @param pctxt       Pointer to context block structure.
 *
 * @param pvalue      Pointer to Asn1UniversalString structure to be
 *                    populated with the decoded information.
 *
 * @return            Completion status of operation:
 *                      - 0 (0) = success,
 *                      - negative return value is error.
 */
EXTERNOER int oerDecUnivStr(OSCTXT* pctxt, ASN1UniversalString* pvalue);
...
EXTERNOER int oerDecDynBitStr64
 ...
 *
 * @param pctxt       Pointer to context block structure.
 * @param pvalue      Pointer to character array to receive null-terminated
 *                    char string.  If null, the string is decoded but the
 *                    content is discarded.
 * @param sz          Size of the array. It must be large enough to hold the
 *                    decoded string with the null terminator.
 * @return            Completion status of operation:
 *                      - 0 (0) = success,
 *                      - negative return value is error.
 */
EXTERNOER int oerDecCharStr (OSCTXT *pctxt, char* pvalue, OSSIZE sz);
...
/**
 * This function is used to decode an OER object identifier value into
 * a dynamic OID structure.
 *
 * @param pctxt       Pointer to context block structure.
 * @param pvalue      Pointer to variable to receive decoded value.
 * @return            Completion status of operation:
 ...
 *                       - negative return value is error.
 */
EXTERNOER int oerDecDynObjId (OSCTXT* pctxt, ASN1DynOBJID* pvalue);
 ...
 *                       - negative return value is error.
 */
EXTERNOER int oerDecRelObjId (OSCTXT* pctxt, ASN1OBJID* pvalue);
...
EXTERNOER int oerDecUnrestSignedUInt64 (OSCTXT* pctxt, OSUINT64* pvalue);
   ...
   #define oerDecUnrestSignedSize(pctxt,pvalue) \
      oerDecUnrestSignedUInt32(pctxt, pvalue)
#elif defined OSSIZE_IS_64BITS
#define oerDecUnrestSignedSize(pctxt,pvalue) \
      oerDecUnrestSignedUInt64(pctxt, pvalue)
#endif
...
/**
 * This function decodes an OER unrestricted 8-bit unsigned integer at the
 * current message buffer/stream location and advances the pointer to the
 * next field.  It is assumed that the value will fit in an 8-bit integer
 * variable.
 *
 * @param pctxt       Pointer to context block structure.
 ...
 *                       - negative return value is error.
 */
EXTERNOER int oerDecUnrestUInt8 (OSCTXT* pctxt, OSUINT8* pvalue);

/**
 * This function decodes an OER unrestricted 16-bit unsigned integer at the
 * current message buffer/stream location and advances the pointer to the
 * next field.  It is assumed that the value will fit in an 16-bit integer
 * variable.
 *
 * @param pctxt       Pointer to context block structure.
 * @param pvalue      Pointer to decoded 16-bit integer value.
 ...
 *                       - negative return value is error.
 */
EXTERNOER int oerDecUnrestUInt16 (OSCTXT* pctxt, OSUINT16* pvalue);
 ...
 *
 * @param pctxt       Pointer to context block structure.
 * @param ppString    Pointer to string variable to receive decoded value
 *                      in string form (YYYY-MM-DD).
 * @param flags       Set of flags: OSYEAR, OSMONTH, OSDAY, etc.
 * @return            Completion status of operation:
 *                       - 0 (0) = success,
 *                       - negative return value is error.
 */
EXTERNOER int oerDecDateStr(OSCTXT *pctxt, char **ppString, OSUINT32 flags);
 ...
 * @param pctxt       Pointer to context block structure.
 * @param ppString    Pointer to string variable to receive decoded value
 *                      in string form (YYYY-MM-DDTHH:MM:SS).
 *                      n - set digit number of fraction part.
 * @param flags       Set of flags: OSYEAR, OSMONTH, OSHOURS, etc.
 * @return            Completion status of operation:
 *                       - 0 (0) = success,
 *                       - negative return value is error.
 */
EXTERNOER int oerDecDateTimeStr(OSCTXT *pctxt, char **ppString,
                                OSUINT32 flags);
 ...
 *                       - negative return value is error.
 */
EXTERNOER int oerDecDurationStr(OSCTXT *pctxt, char **ppString);

/**
 * This function is used to decode an ISO 8601 TIME "DIFF" value.
 *
 * @param pctxt       Pointer to context block structure.
 * @param pString     Pointer to string variable to receive decoded value
 *                      in string form.
 * @return            Completion status of operation:
 *                       - 0 (0) = success,
 *                       - negative return value is error.
 */
EXTERNOER int oerDecTimeDiffStr(OSCTXT *pctxt, char *pString);
 ...
 * @param flags       Set of flags: OSHOURS, OSMINUTES, etc.
 * @return            Completion status of operation:
 *                       - 0 (0) = success,
 *                       - negative return value is error.
 */
EXTERNOER int oerDecTimeOfDayStr(OSCTXT *pctxt, char **ppString,
                                 OSUINT32 flags);
...
* @param pvalue      Pointer to binary data to encode.
* @param numbits     Number of bits in the bit string.
* @param encBits     Number of bits to encode (>= numbits). Trailing zero bits
*                    will be added, as needed, to fill out the string.
* @return            Completion status of operation:
*                       - 0 (0) = success,
*                       - negative return value is error.
*/
EXTERNOER int oerEncBitStrPad
 ...
 * @param pctxt       Pointer to context block structure.
 *
 * @param pvalue      Pointer to Asn1BMPString structure that
 *                    contains the value to be encoded.
 *
 * @return            Completion status of operation:
 *                      - 0 (0) = success,
 *                      - negative return value is error.
 */
EXTERNOER int oerEncBMPStr(OSCTXT* pctxt, ASN1BMPString* pvalue);
 ...
 * @param pctxt       Pointer to context block structure.
 *
 * @param pvalue      Pointer to Asn1UniversalString structure that
 *                    contains the value to be encoded.
 *
 * @return            Completion status of operation:
 *                      - 0 (0) = success,
 *                      - negative return value is error.
 */
EXTERNOER int oerEncUnivStr(OSCTXT* pctxt, ASN1UniversalString* pvalue);
 ...
 *                       - negative return value is error.
 */
EXTERNOER int oerEncRelObjId (OSCTXT* pctxt, const ASN1OBJID* pvalue);
 ...
 *
 * @param pctxt       Pointer to context block structure.
 * @param pString     Character string variable containing value to be
 *                      encoded in string form (YYYY-MM-DD).
 * @param flags       Set of flags: OSYEAR, OSMONTH, OSDAY, etc.
 * @return            Completion status of operation:
 *                       - 0 (0) = success,
 *                       - negative return value is error.
 */
EXTERNOER int oerEncDateStr(OSCTXT *pctxt, const char *pString,
                            OSUINT32 flags);
 ...
 * @param pctxt       Pointer to context block structure.
 * @param pString     Character string variable containing value to be
 *                      encoded in string form (YYYY-MM-DDTHH:MM:SS).
 * @param flags       Set of flags: OSYEAR, OSMONTH, OSHOURS, etc.
 * @return            Completion status of operation:
 *                       - 0 (0) = success,
 *                       - negative return value is error.
 */
EXTERNOER int oerEncDateTimeStr(OSCTXT *pctxt, const char *pString,
                                OSUINT32 flags);
 ...
 *                       - negative return value is error.
 */
EXTERNOER int oerEncDurationStr(OSCTXT *pctxt, const char *pString);
 ...
 * @param pctxt       Pointer to context block structure.
 * @param pString     Character string variable containing value to be
 *                      encoded in string form (HH:MM:SS).
 * @return            Completion status of operation:
 *                       - 0 (0) = success,
 *                       - negative return value is error.
 */
EXTERNOER int oerEncTimeDiffStr(OSCTXT *pctxt, const char *pString);
 ...
 *                       - negative return value is error.
 */
EXTERNOER int oerEncTimeOfDayStr(OSCTXT *pctxt, const char *pString,
                                 OSUINT32 flags);

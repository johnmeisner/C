...
class EXTOERCLASS ASN1OERMessageBuffer : public ASN1MessageBuffer {
 ...
 public:
   ...
   /**
    * Binary dump not supported for OER. Method is needed as a placeholder
    * for client/server code generation.
    */
   inline void binDump (const char* ) {}
   ...
   /**
    * Set bit trace not supported for OER.  Method is needed as a placeholder
    * for client/server code generation.
    */
   inline void setTrace (OSBOOL ) {}

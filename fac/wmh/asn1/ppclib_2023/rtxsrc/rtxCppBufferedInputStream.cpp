...
#include "rtxsrc/rtxCppBufferedInputStream.h"

OSBufferedInputStream::OSBufferedInputStream (OSRTInputStream& /*in*/)
{
   if (!isInitialized ()) return;

   mInitStatus = rtxStreamBufferedCreate (getCtxtPtr(), 0);

/*
 * Copyright (c) 2012-2023 Objective Systems, Inc.
 *
 ...
 *
 * @param pctxt       Pointer to context block structure.
 * @param pvalue      Pointer to receive decoded 16-bit integer value.
 ...
 *
 * @param pctxt       Pointer to context block structure.
 * @param pvalue      Pointer to receive decoded 32-bit integer value.
 *                    Pass null to discard the decoded value.
...
/**
 * This function decodes an 64-bit signed integer at the current
 * message buffer/stream location and advances the pointer to the next field.
 *
 * @param pctxt       Pointer to context block structure.
 * @param pvalue      Pointer to receive decoded 64-bit integer value.
 *                    Pass null to discard the decoded value.
 * @param nbytes      Number of bytes to decode (8 or less).
 * @return            Completion status of operation:
 *                       - 0 (0) = success,
 *                       - negative return value is error.
 */
...
/**
 * This function decodes a 64-bit unsigned integer at the current
 * message buffer/stream location and advances the pointer to the next field.
 *
 * @param pctxt       Pointer to context block structure.

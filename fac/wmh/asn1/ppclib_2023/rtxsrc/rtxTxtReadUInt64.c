...
int rtxTxtReadUInt64 (OSCTXT* pctxt, OSUINT64* pvalue)
{
   OSBOOL minus = FALSE;
   ...
   /* It would appear RTERR_ENDOFBUF is OK since we break the loop and
      return zero (a good status).  However, need to set stat to zero so
      pvalue is set.. */

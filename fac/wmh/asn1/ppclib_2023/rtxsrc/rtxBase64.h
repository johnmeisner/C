 ...
 * @param url Flag indicating if base64 string is used in a URL
 * @return Converted integer value or -1 if invalid character.
 */
 ...
 * @param url Flag indicating if base64 string is used in a URL
 * @return Converted character value or -1 if invalid index;
 */

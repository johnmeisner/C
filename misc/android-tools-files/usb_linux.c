...
//        DBGX("[ scanning %s ]\n", busname);
        while((de = readdir(devdir))) {
            ...
            unsigned vid, pid;
            size_t desclength;
            // Added by Kevin 20200824 -- for adb supporting USB3.0 
            int is_ss = 0; /* boolean */
            // End of added by Kevin 20200824 -- for adb supporting USB3.0
...
//            DBGX("[ scanning %s ]\n", devname);
            ...
            // Added by Kevin 20200824 -- for adb supporting USB3.0
            printf("device->bcdUSB = 0x%x\n", device->bcdUSB);
            if (device->bcdUSB == 0x0300 || device->bcdUSB == 0x0310) {

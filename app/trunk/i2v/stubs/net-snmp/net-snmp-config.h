...
//TM !!TODO!! rsutable.c calls this as part of InitTable()
//#undef HAVE_USLEEP
...
#define NETSNMP_CONFIGURE_OPTIONS " 'CC=gcc' 'CFLAGS=-fno-strict-aliasing -g -O2 -Wall -Wextra -Ulinux -Dlinux=linux  -D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fwrapv -fno-strict-aliasing -pipe -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64  -I/usr/lib/x86_64-linux-gnu/perl/5.22/CORE  ' 'LDFLAGS=' 'CPPFLAGS=' 'CPP=gcc -E -Iinclude -I./include -I./agent/mibgroup -I. -I. -DDONT_INC_STRUCTS -DBINDIR=/usr/local/bin -x c'"

...
#define max_repetitions errindex
    ...
    /* I dont understand why *securityName is junk but securityNameLen is valid 
     * when passed down the handlers. Maybe it is freed or calloc gives address we can't reach?
     * Solution: Just copy it over to here to be preserved.
